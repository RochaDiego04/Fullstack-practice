export const confirmationTemplate = (name: string, token: string) => `
            ...
            <tr>
              <td style="padding:32px 40px;">
                ...
                <p style="margin:0 0 20px;font-size:15px;line-height:1.6;color:#475569;">
                  Gracias por registrarte en CashTrackr. Para activar tu cuenta usa el siguiente código de confirmación:
                </p>
                ...
                <p style="margin:0 0 20px;font-size:15px;line-height:1.6;color:#475569;">
                  O haz clic en el botón para confirmar tu cuenta directamente:
                </p>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                  <tr>
                    <td align="center">
                      <a href="${process.env.FRONTEND_URL}/auth/confirm-account?token=${token}"
                ...
                <p style="margin:0;font-size:13px;line-height:1.5;color:#94a3b8;">
                  Si no creaste esta cuenta puedes ignorar este mensaje. El código expira en <strong>10 minutos</strong>.
                </p>
              </td>
            </tr>
